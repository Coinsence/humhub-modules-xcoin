            ...
            <tr>
                ...
                <td style="vertical-align: middle;">
                    <?php if ($space->dao_address) : ?>
                        <?= Html::a(Html::img("https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={$space->dao_address}&choe=UTF-8", ['alt' => 'ethereum address', 'style' => 'width: 100%; max-width: 250px']), "https://rinkeby.etherscan.io/address/$space->dao_address", ['target' => '_blank']) ?>
                    <?php else : ?>
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">
                    <?php if ($space->coin_address) : ?>
                        <?= Html::a(Html::img("https://chart.googleapis.com/chart?chs=300x300&cht=qr&chl={$space->coin_address}&choe=UTF-8", ['alt' => 'ethereum address', 'style' => 'width: 100%; max-width: 250px']), "https://rinkeby.etherscan.io/address/$space->coin_address", ['target' => '_blank']) ?>
                    <?php else : ?>
                        <span class="label label-default"><?= Yii::t('XcoinModule.ethereum', 'unavailable') ?></span>
                    <?php endif; ?>
                </td>
