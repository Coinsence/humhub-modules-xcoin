...
<?php ModalDialog::begin(['header'=> '' , 'closable' => false]) ?>
...
<div class="modal-body">
    <div class="row" style="text-align: center;">
        <?= ModalButton::submitModal(null, Yii::t('XcoinModule.product', 'Create from personal profile'))->id('submit-personal-product'); ?>
    </div>
    ...
    <div class="row" style="display: flex; align-items: center;">
        <div class="col-md-10">
            ...
            $form->field($product, 'space_id')->widget(Select2::class, [
                ...
                ->label(Yii::t('XcoinModule.product', 'Create from space'))
                ->hint(Yii::t('XcoinModule.product', 'Leave empty if you want to create automatically a new space'));
            ?>
        </div>
        <hr>
        <div class="col-md-2">
