                        ...
                        <div style="position: relative">
                            <div class="col-sm-6 col-md-4 col-lg-3">
                                ...
                                <?php if (SpaceHelper::canReviewProject($product->marketplace->space) || PublicOffersHelper::canReviewSubmittedProjects()): ?>
                                    <?php if ($product->review_status == Product::PRODUCT_NOT_REVIEWED) : ?>
                                        <?= Html::a('<i class="fa fa-check"></i> ' . Yii::t('XcoinModule.product', 'Trusted'), ['/xcoin/marketplace/review-product', 'id' => $product->id, 'status' => Product::PRODUCT_REVIEWED, 'container' => $this->context->contentContainer], ['style' => ["position" => "absolute", "top" => "20px", "right" => "30px"]]) ?>
                                    <?php else : ?>
                                        <?= Html::a('<i class="fa fa-close"></i> ' . Yii::t('XcoinModule.product', 'Untrusted'), ['/xcoin/marketplace/review-product', 'id' => $product->id, 'status' => Product::PRODUCT_NOT_REVIEWED, 'container' => $this->context->contentContainer],['style' => ["position" => "absolute", "top" => "20px", "right" => "30px"]]) ?>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </div>
                        </div>
