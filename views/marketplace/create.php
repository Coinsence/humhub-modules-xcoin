...
<?php ModalDialog::begin(['header' => Yii::t('XcoinModule.marketplace', 'Create Marketplace'), 'closable' => false]) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <?= $form->field($model, 'description')->widget(RichTextField::class, ['preset' => 'full'])
                ->hint(Yii::t('XcoinModule.marketplace', 'Please enter your product description')) ?>
        </div>
        <div class="col-md-12">
            <?=
            $form->field($model, 'asset_id')->widget(Select2::class, [
                'data' => $assets,
                'options' => ['placeholder' => '- ' . Yii::t('XcoinModule.marketplace', 'Select coin') . ' - ', 'value' => ($defaultAsset) ? $defaultAsset->id : []],
